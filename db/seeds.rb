...
ice_cream_cone_def = Definition.create!(user: User.first, approved: true,content: "'<% %>': Ice cream cone evaluates ruby code but does not print", word: ice_cream_cone, technology: ruby)
model_def = Definition.create!(user: User.first, approved: true,content: "A blueprint for creating instances; manages data in the database", word: model, technology: ruby)
...
route_def = Definition.create!(user: User.first, approved: true,content: "A route is a path that allows you access a page of your preference; it connects with an appropriate method and renders an appropriate view", word: route, technology: rails)
