...
associations_def = Definition.create!(user: User.first,approved: true, content: "The HTML files (what is displayed on the browser)", word: associations, read_more_url: "https://medium.com/swlh/the-simplest-way-to-understand-associations-in-rails-dc03cfe067f2", read_more_at: "Medium blog")
belongs_to_def = Definition.create!(user: User.first,approved: true, content: "a one-to-one relationship between two tables in which one of them belongs to the other. This is based on where the foreing keys are located in that relationship.",word: "belongs_to", read_more_url:[ "https://www.freecodecamp.org/news/understanding-the-basics-of-ruby-on-rails-sql-databases-and-how-they-work-7a628cd42073/"], read_more_at:["FreeCodeCamp Blog"])
