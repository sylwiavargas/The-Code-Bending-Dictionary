...
crud=Definition.create!(content:"An acronym for CREATE, READ, UPDATE, and DELETE. These are 4 basic actions that we can use when dealing with the database ", word: crud, technology: general_tech )
getter_method=Definition.create!(content: "This method is used to retrieve or GET a value of an instance variable", word: getter_method, technology: general_tech )
...
setter_method=Definition.create!(content: "This method is used to SET or assign the value of an instance variable", word: setter_method, technology: general_tech )
